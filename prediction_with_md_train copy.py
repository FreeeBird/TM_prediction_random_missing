'''
Author: FreeeBird
Date: 2022-11-12 15:23:53
LastEditTime: 2022-11-12 15:23:54
LastEditors: FreeeBird
Description: 
FilePath: /TM_Prediction_With_Missing_Data/prediction_with_md_train copy.py
'''
'''
Author: FreeeBird
Date: 2022-04-18 16:01:41
LastEditTime: 2022-11-08 20:28:09
LastEditors: FreeeBird
Description: 
...
if __name__ == '__main__':
    ...
    m_adj = np.load(get_adj_matrix('abilene'))
    args.m_adj=m_adj
    # all rounds metrices
    ...
    for i in range(1,args.rounds+1):
        ...
        ,missing_ratio=args.missing_ratio,missing_index=i,batch_size=args.batch_size,num_workers=args.cpu,random=[False,False,False],std=args.std)
